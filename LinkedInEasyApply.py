...
driver.get("https://www.linkedin.com/jobs/search/?f_LF=f_AL&geoId=102257491&keywords="
           "marketing%20intern&location=London%2C%20England%2C%20United%20Kingdom&redirect=false&position=1&pageNum=0")
...
time.sleep(5)
email_field = driver.find_element(By.PARTIAL_LINK_TEXT,"username")
